...
class LoadingzonesApi(object):
    ...
    def loadingzone(self, **kwargs):
        """
        Location of kerbside loading zones
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.loadingzone(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method loadingzone" % key
                )
            params[key] = val
        del params['kwargs']


        resource_path = '/roads/static/loadingzones'.replace('{format}', 'json')
        path_params = {}
