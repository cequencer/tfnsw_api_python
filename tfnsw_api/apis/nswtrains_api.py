...
class NswtrainsApi(object):
    ...
    def alerts(self, **kwargs):
        """
        GTFS-realtime alerts for regional services
        ...
        resource_path = '/gtfs/alerts/nswtrains'.replace('{format}', 'json')
        path_params = {}
    ...
    def stop_times(self, **kwargs):
        ...
        resource_path = '/gtfs/realtime/nswtrains'.replace('{format}', 'json')
        path_params = {}
    ...
    def timetables(self, **kwargs):
        ...
        resource_path = '/gtfs/schedule/nswtrains'.replace('{format}', 'json')
        path_params = {}
    ...
    def vehicle_positions(self, **kwargs):
        """
        GTFS-realtime vehicle positions for NSW Trains
        Please see the General Transit Feed Specification GTFS-realtime documentation here:\nhttps://developers.google.com/transit/gtfs-realtime/\n\nThe GTFS-realtime data exchange format is based on Protocol Buffers:\nhttps://developers.google.com/protocol-buffers/\n\nPlease review the Real time {mode} Technical Documentation\n\nYou may optionally add a parameter 'debug' of value 'true' and type 'query' to retrieve protocol messages in a text-based format.\n\nKnown issues:\n\n\u2022The text format may be truncated.
        ...
        resource_path = '/gtfs/vehiclepos/nswtrains'.replace('{format}', 'json')
        path_params = {}
