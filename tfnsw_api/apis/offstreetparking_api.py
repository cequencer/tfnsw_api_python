...
class OffstreetparkingApi(object):
    """
    ...
    def offstreetparking(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.offstreetparking(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method offstreetparking" % key
                )
            params[key] = val
        del params['kwargs']


        resource_path = '/roads/static/offstreetparking'.replace('{format}', 'json')
        path_params = {}
