...
class StatusApi(object):
    ...
    def traffic_site_status(self, **kwargs):
        """
        Current status of the Live Traffic NSW website
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.traffic_site_status(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method traffic_site_status" % key
                )
            params[key] = val
        del params['kwargs']


        resource_path = '/live/status'.replace('{format}', 'json')
        path_params = {}
